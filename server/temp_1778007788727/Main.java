public class Main {
    ...
    public static boolean rec(int ind, String s, HashSet<String> che, String curr, HashMap<String, Boolean> [] dp){
        ...
        return Tracer.exit(_tid_3200, c1 || c2);
    }
